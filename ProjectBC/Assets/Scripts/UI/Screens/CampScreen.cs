...
public class CampScreen : MainScreen
{
    ...
    private void Start()
    {
        ...
        stoneButton.onClick.AddListener(() => ToastMsg.instance.ShowMessage("개발중입니다", 0.5f));
        dailyDungeonButton.onClick.AddListener(() => ToastMsg.instance.ShowMessage("개발중입니다", 0.5f));
    }
