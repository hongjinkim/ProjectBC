...
{
    [Header("Parts")]
    public CharacterBase Front;
    public CharacterBase Back;
    public CharacterBase Left;
    public CharacterBase Right;
    public List<CharacterBase> Parts;
    ...
    private List<CharacterBase> PartsExceptBack => new List<CharacterBase> { Front, Left, Right };
    ...
    public CharacterBase Active { get; private set; }
